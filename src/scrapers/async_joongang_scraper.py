...
async def main(urls):
    ...
    save_to_csv(progress['article_list'], 'joongang_article.csv')
...
# URL 리스트
file_path = 'src/scrapers/joongang.csv'  # Replace this with the correct path to your CSV file
