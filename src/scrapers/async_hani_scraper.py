...
async def main(urls):
    ...
    save_to_csv(progress['article_list'], 'src/article_data/hani_article.csv')
...
# URL 리스트
file_path = 'src\\raw_data\hani.csv'  # Replace this with the correct path to your CSV file
