...
const articles = [
    ...
    { article_id: '5', title: '이재명 2기 체제, 당내 민주주의와 협치 주도가 최대 과제', content: "이 대표 2기 체제 민주당의 가장 큰 과제는 민생과 개혁이다. 국회 과반 의석을 점한 정당으로서 당면한 민생·경제 위기를 극복할 해법을 능동적으로 내놓고, 연금개혁·기후위기·지방소멸 등 국가적 의제의 대안도 책임 있게 제시해야 한다. 윤석열 정부의 권력 사유화, 방송장악, 뉴라이트식 역사 뒤집기 같은 퇴행에 단호하게 맞서야 함은 물론이다.", logits: [-0.7666, -0.1259] },
    { article_id: '6', title: '‘친명만의 리그’로 연임 성공한 이재명 대표의 과제', content: "이 대표가 압승을 즐길 입장도 아니다. 권리당원 투표율(42.18%)이 과반을 넘기지 못하며 저조한 수준에 머물렀다. 특히 보수 강세인 대구·경북의 온라인 투표율(52.24%)이 1위인 반면, 당 텃밭인 호남은 20%대로 하위권에 머무른 게 주목된다. ‘친명 독식’ 일색인 전당대회에 거부감을 품은 전통적인 당 지지층은 등을 돌리고, 소수 강성 지지층만 투표에 열을 올린 정황이 뚜렷하다.", logits: [ 0.2735, -1.3250] },
    { article_id: '7', title: '경축식 파행에 아쉬움 남긴 통일 독트린…씁쓸했던 광복절', content: "윤 대통령의 언급대로 남북이 자유민주주의 체제로 통일국가가 돼야 완전한 광복이 실현된다는 점, 세계 최악의 수준인 북한 인권이 조속히 개선돼야 한다는 점에는 이견이 있을 수 없다.", logits: [ 2.3514, -2.8987] },
    { article_id: '8', title: '“자유 통일” 외친 윤 대통령, ‘적대국 남북’ 해소가 먼저다 ', content: "그와 달리 윤 대통령은 북한 체제 붕괴를 전제하고, 남한 주도의 흡수 통일을 노골화했다. 북한 정권의 변화를 기대할 수 없으니 당국과 주민을 분리해서 접근하겠다는 발상도 비현실적이다. 그래놓고 남북 간 대화협의체를 제안했는데, 북한이 응하겠는가.", logits: [-0.6228, -0.2524] },
